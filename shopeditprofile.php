...
$qry1="select * from tbl_shopreg where loginid=$id";
 ...
 if (isset($_POST['submit'])) {
   ...
   $sql="UPDATE `tbl_shopreg` SET `shopname`='$shopname' ,`licenseno`='$licenseno'  WHERE loginid='$id'";
...
#customers th {
  ...
  <center>
   <form action="#" method="post">
      ...
      <tr>
       <td>Shopname</td>
      <td><input type="text" name="shopname" id="name1" onchange="nm1();"  value="<?php echo $shopname;?>"</td>
...
<!--        <tr>
  ...
  <tr>
      ...
      <td>Licenseno</td>
      <td><input type="text" name="licenseno" id="license" onchange="lic();" value="<?php echo $licenseno;?>"</td>
 <label style="display:none ; color:red"  id="license_l"></label>
