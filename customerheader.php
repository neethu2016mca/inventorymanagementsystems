		...
		<div class="header-bot_inner_wthreeinfo_header_mid">
			...
			<div class="col-md-8 header">
				...
				<ul>
					...
					<li>
						<span class="fa fa-phone" aria-hidden="true"></span> 001 234 5679
					</li>

					<li>
						<span class="fa fa-phone" aria-hidden="true"></span> 001 234 5680
					</li>
					<li>
...
<!--						<button type="submit" class="btn btn-default" aria-label="Left Align">
				...
				<div class="top_nav_right">
					<div class="wthreecartaits wthreecartaits2 cart cart box_1">
                                            <form action="custcheckout.php" method="post" class="last">
			...
			<div class="modal-content">
				...
				<div class="modal-body modal-body-sub_agile">
					...
					<div class="modal_body_left modal_body_left1">
						...
						<p>
							Come join the  Shoppy! Let's set up your Account.
						</p>
						<form action="#" method="post">
							<div class="styled-input agile-styled-input-top">
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav menu__list">
								<li class="active">
									<a class="nav-stylehead" href="customerhome.php">Home
...
<!--								<li class="">
								...
								<li class="">
									<a class="nav-stylehead" href="viewcustomerprofile.php">View Profile</a>
								</li>
                                                                <li class="">
                                                                    <a class="nav-stylehead" href="changepassword.php">Change Password</a>
								</li>
                                                                <li class="">
									<a class="nav-stylehead" href="products11.php">View Products</a>
								</li>
                                                                 <li class="">
									<a class="nav-stylehead" href="viewproducts.php">Offer Products</a>
								</li>
								<li class="">
