			...
			<div class="col-md-5 single-right-left ">
				<div class="grid images_3_of_2">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="image/churidhar00.jpg">
								<div class="thumb-image">
									<img src="image/churidhar00.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="image/churidhar01.jpg">
								<div class="thumb-image">
									<img src="image/churidhar01.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="image/churidhar02.jpg">
								<div class="thumb-image">
									<img src="image/churidhar02.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
						</ul>
...
<!--								<input type="submit" name="submit" value="Add to cart" class="button" />-->
                                                                 <a href="#" data-toggle="modal" data-target="#myModal1"><input type="submit" name="submit" value="Add to cart"  class="button" />
                                                                                                </a>
							</fieldset>
						</form>
					</div>
