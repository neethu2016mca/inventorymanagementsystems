...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<link href="//fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800" rel="stylesheet">
        <script src="staffh/staff/js/vendor/modernizr-2.8.3.min.js"></script>
       <div align="center">
                    <style>
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav menu__list">
								<li class="active">
                                                                    <a class="nav-stylehead" href="shophome.php">Home
...
<!--								<li class="">
								...
								<li class="">
									...
									<a class="nav-stylehead" href="viewproducts.php">Offer Products</a>
                                                                ...
                                                                <li class="">
                                                                    <a class="nav-stylehead" href="debitcarddetails.php">Debit Card Details</a>
								</li>
<!--								<li class="">
        ...
        <img src="frontcus.jpg" width="1500px;" height="350px;"/> <br><br><br><br><br><br><br>
        <br><br>
        <br><br>
        <br><br>
        <br>
