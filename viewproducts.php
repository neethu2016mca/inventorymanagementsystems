...
$query1="SELECT * FROM tbl_damageproducts as dp,tbl_image as i where dp.imageid=i.imageid";
    ...
    <body>
				...
				<div class="wrapper"style="width:1400px;">
					...
					<div class="product-sec1">
                                            <h3 class="heading-tittle">20% Offer Products</h3>
...
<!--                                                                                               <input type="submit" name="submit" value="Add to cart"  class="button" />-->
                                                                                                <input type="hidden" value="<?php echo $row["dproductid"]; ?>" name="dproductid">
